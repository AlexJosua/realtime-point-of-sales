...
import { AuhtFormState } from "@/types/auth";
import {
  createUserSchema,
  updateUserSchema,
} from "@/validations/auth-validations";

export async function createUser(prevState: AuhtFormState, formData: FormData) {
...
export async function updateUser(prevState: AuhtFormState, formData: FormData) {
...
export async function deleteUser(prevState: AuhtFormState, formData: FormData) {
